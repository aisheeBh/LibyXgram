...
<body>
    ...
    <div class="container">
        <header class="header">
            <h1><a href="python.php">LibyXgram | Python</a></h1>
            <div class="search-bar">
                <input type="text" id="search-input" placeholder="Search for books on Python...">
            </div>
        </header>
        ...
        <nav class="nav">
            <ul class="category-list">
                ...
                $spreadsheetUrl = 'https://docs.google.com/spreadsheets/d/1Y6zGY6Oc7ArcrQ1LMJhryXYk30i6jIMnFg9JFT2Vmrg/edit?usp=sharing';
