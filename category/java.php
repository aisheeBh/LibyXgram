...
<body>
    ...
    <div class="container">
        <header class="header">
            <h1><a href="java.php"><br>LibyXgram | Java</a></h1>
        ...
        <nav class="nav">
            <ul class="category-list">
                ...
                $spreadsheetUrl = 'https://docs.google.com/spreadsheets/d/1_-LmGEsH4vwoJEEEJSs6nLFthfFcPBq6IHWmbi8-qtg/edit?usp=sharing';
